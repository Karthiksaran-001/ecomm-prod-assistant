...
from prod_assitant.etl.data_scrapper import FlipkartScrapper
from prod_assitant.etl.data_ingestion import DataIngestion
import os
...
if st.button("🚀 Start Scraping"):
    ...
    if not product_inputs:
        ...
        for query in product_inputs:
            ...
            results = flipkart_scraper.scrape_filpkart_products(query, max_products=max_products, review_count=review_count)
